...
<template>
  <nav class="bg-black sticky top-0">
    ...
    <router-link to="/manage-booking" class="text-white  hover:text-blue-200">Manage Booking</router-link>
    <router-link to="/about-us" class="text-white t hover:text-blue-200">About Us</router-link>
    <router-link to="/contact-us" class="text-white  hover:text-blue-200">Contact Us</router-link>
