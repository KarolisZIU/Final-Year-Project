...
<template>
  <PageWrapper title="Admin Dashboard" max-width="max-w-4xl">
      ...
      <div class="shrink-0">
        ...
        <div class="flex flex-col gap-3 mt-4">
          <button
            ...
            class="bg-white hover:bg-indigo-300 border border-slate-300 rounded-xl p-4 text-left shadow-sm transition"
          >
