...
<template>
  ...
  <PageWrapper title="Booking Summary" max-width="max-w-2xl">
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
      ...
      <p v-if="service">
        <span class="font-medium">Service:</span> {{ service.service_name }}
      </p>
      <p v-if="service">
        <span class="font-medium">Price:</span> €{{ service.service_price }}
      </p>
      <p v-if="service">
      ...
      <p v-if="staff">
        <span class="font-medium">Staff:</span> {{ staff.staff_name }}
      </p>
